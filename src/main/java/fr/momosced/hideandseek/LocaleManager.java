...
public class LocaleManager {
    ...
    private static final FileConfiguration def_locale = YamlConfiguration.loadConfiguration(new File(Main.getInstance().getDataFolder() + "/locales/default.yml"));
    ...
    public static String roleSentence(PlayerManager pm, boolean isNew) {
